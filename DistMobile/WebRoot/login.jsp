...
<html>
   ...
   <body   style="background-image:url(appIcon/appIcon/background.png);background-position:center; background-repeat:inherit " >
   
   		<!-- 导航栏  begin    class="container loginPage"   -->		
